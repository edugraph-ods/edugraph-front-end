...
import { createStudyPlan, getJson, deleteJson } from "../../../../shared/infrastructure/http/apiClient";
import { buildStudentStudyPlansPath, buildStudyPlanDetailPath, buildStudyPlanDeletePath } from "../../../../shared/infrastructure/http/apiPaths";
